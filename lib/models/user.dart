...
/// }
/// 
// studente (non è mai admin)
// super admin (isAdmin di default e nascosto agli admin, può modificare gli admin)
// amministratore (isAdmin di default=true)
// tutor coordinatore (isAdmin di default=FALSE)
// tutor organizzatore (isAdmin di default=FALSE)
...
class UserModel {
    ...
    String get fullname => registry==null 
                        ...
                        : registry!.firstName==null && registry!.completeName!=null 
                          ...
                          : '${registry!.lastName ?? ''} ${registry!.firstName ?? ''}';
    ...
    String userRole(){
      switch(userType){
        ...
        case UserType.student:
          return 'Studente';
        case UserType.organizerTutor:
          return 'Tutor Organizzatore';
        case UserType.coordinatorTutor:
          return 'Tutor Coordinatore';
    ...
    factory UserModel.fromMap(Map<String, dynamic> json) => UserModel(
        ...
        userType: json["userType"] == null ? UserType.student : UserType.values[json["userType"] ?? 0],
